...
class UploadCourseVideoAction extends Action
{
    public $modelClass = 'common\modules\video\models\Video';

    public $view = '@common/modules/video/views/course/upload-video';
...
//        }
    ...
    public function uploadMedia()
    {
        ...
        return [
            'redirect' => to(['course/view', 'id' => $model->id]),
            'status' => 200,
        ];
