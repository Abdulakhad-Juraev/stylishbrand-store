...
use Yii;
use common\modules\video\models\VideoAdditionalOption;
use common\modules\video\models\search\VideoAdditionalOptionSearch;
use soft\web\SoftController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class VideoAdditionalOptionController extends SoftController
{
    ...
    {
        $model = new VideoAdditionalOption([
            'video_id' => $video_id
        ]);
    ...
    /**
     * @param $id
     * @return VideoAdditionalOption
     * @throws yii\web\NotFoundHttpException
     */
    public function findModel($id)
    {
        $model = VideoAdditionalOption::find()->andWhere(['id' => $id])->one();
        if ($model == null) {
            not_found();
        }
        return $model;
