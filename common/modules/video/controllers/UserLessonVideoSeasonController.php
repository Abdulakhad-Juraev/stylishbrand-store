...
use common\modules\video\models\search\UserLessonVideoSeasonSearch;
use soft\web\SoftController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class UserLessonVideoSeasonController extends SoftController
{
    ...
    {
        $searchModel = new UserLessonVideoSeasonSearch();
    ...
    {
        $model = new UserLessonVideoSeason();
    ...
    /**
     * @param $id
     * @return UserLessonVideoSeason
     * @throws yii\web\NotFoundHttpException
     */
    public function findModel($id)
    {
        $model = UserLessonVideoSeason::find()->andWhere(['id' => $id])->one();
        if ($model == null) {
            not_found();
        }
        return $model;
