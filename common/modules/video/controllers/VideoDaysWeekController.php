...
use common\modules\video\models\search\VideoDaysWeekSearch;
use soft\web\SoftController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class VideoDaysWeekController extends SoftController
{
    ...
    */
    ...
    {
        $searchModel = new VideoDaysWeekSearch();
    ...
    */
    ...
    /**
    * @param $id
    * @return VideoDaysWeek
    * @throws yii\web\NotFoundHttpException
    */
    public function findModel($id)
    {
        $model = VideoDaysWeek::find()->andWhere(['id' => $id])->one();
        if ($model == null){
            not_found();
        }
        return $model;
