...
<?php if ($model->audio_has_org_src): ?>
    <div class="alert alert-warning">
        Diqqat!!! Siz rostdan ham ushbu Kurs uchun yangi audio yuklashni xoxlaysizmi? <br>
        Bunda avvalgi yuklangan audio o'chib ketadi!!
    </div>
<?php endif ?>
...
<div id="upload-area">
    ...
    <?= $form->field($model, 'audio_org_src')->widget('\kartik\widgets\FileInput', [
        'options' => [
            'multiple' => false,
            'accept' => 'audio/*',
        ],
        ...
        'pluginOptions' => [
            ...
            'maxFileCount' => 1,
            'maxFileSize' => Video::maxAudioSize(),
            'dropZoneTitle' => 'Audioni yuklang',
            'msgPlaceholder' => 'Audioni tanlang',
        ],
