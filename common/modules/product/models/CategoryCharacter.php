 ...
 * @property CategoryCharacterLang[] $categoryCharacterLangs
...
class CategoryCharacter extends \soft\db\ActiveRecord
{
    ...
    * @return \yii\db\ActiveQuery
    */
    public function getCategoryCharacterLangs()
    {
        return $this->hasMany(CategoryCharacterLang::className(), ['owner_id' => 'id']);
    }
